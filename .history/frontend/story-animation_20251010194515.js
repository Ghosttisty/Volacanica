...
export function buildDynamicStorySection(scene, mainContainer) {
    ...
    const styles = `
        ...
        .home-animate__text-group, .home-animate__huge-wrap{ align-items:center; display:flex; font-size:max(5.625rem,min(5.58824vw + 1.29412rem,8rem)); font-weight:600; line-height:1; position:relative; margin: 0 1.5vw; white-space:nowrap; }
        ...
        /* Estilos para 'Super' y 'Choreograph' */
        ...
        .default-group, .typewriter-group, .icon-group > span, .home-animate__huge-wrap { font-family: 'Playfair Display', serif; }
    ...
    textGroupsData.forEach(groupData => {
        ...
        if (groupData.animation_type === 'nice-group-entry') {
            ...
            groupHTML = `<p class="home-animate__huge-wrap home-animate__huge">${groupData.text_1 || ''}</p>`;
        }
