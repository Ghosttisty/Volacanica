...
export function buildDynamicStorySection(scene, mainContainer) {
    ...
    const styles = `
        ...
        /* --- CORRECCIÓN DE ICONO --- */
        .home-animate__icon { opacity: 0; width: 6rem; height: auto; display: inline-block; vertical-align: middle; margin: 0 1rem; }
    ...
    requestAnimationFrame(() => {
        ...
        gsap.utils.toArray('.icon-group .home-animate__icon').forEach(icon => {
            // Anima el icono para que aparezca y se mueva a su posición final
            gsap.from(icon, { 
                rotation:-45, 
                yPercent:100, 
                opacity:0, 
