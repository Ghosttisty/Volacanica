...
export function buildDynamicStorySection(scene, mainContainer) {
    ...
    const styles = `
        ...
        .home-animate__text-group{ align-items:center; display:flex; font-size:max(5.625rem,min(5.58824vw + 1.29412rem,8rem)); font-weight:600; line-height:1; position:relative; margin: 0 4vw; white-space:nowrap; }
        ...
        .default-group { font-family: 'Playfair Display', serif; }
    `;
