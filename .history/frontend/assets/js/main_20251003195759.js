...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadHeroSlides() {
        try {
            // CORRECCIÓN: Usamos?populate=* para asegurarnos de que la imagen venga incluida.
            ...
            if (slides && slides.length > 0) {
                slides.forEach((slideData) => {
                    ...
                    // Verificamos que la estructura de la imagen exista antes de usarla
    ...
    async function loadMenu() {
        try {
            // CORRECCIÓN: Usamos una sintaxis de populate más específica para anidación.
